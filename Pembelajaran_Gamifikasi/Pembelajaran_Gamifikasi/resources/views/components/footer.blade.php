<div class="fixed bottom-8 right-6 z-10 group">
    <div class="absolute right-[90px] top-1/2 -translate-y-1/2
    ...
    <div 
        onclick="window.open('https://wa.me/6285855550057?text=Halo%20Admin%20AkuDev,%20saya%20ingin%20bertanya', '_blank')"
        class="w-[78px] h-[78px] 
               bg-green-500 
               rounded-full 
