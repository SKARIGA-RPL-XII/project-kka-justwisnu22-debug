    ...
    <div class="flex">
        ...
        <main class="flex-1 p-6">
            <div class="max-w-4xl mx-auto">
                ...
                <form method="POST" action="{{ route('admin.quiz.update', $quiz->id) }}" class="bg-white rounded-lg shadow-md">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="p-6 border-b">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="exp_reward" value="{{ old('exp_reward', $quiz->exp_reward) }}" min="1" 
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" 
                    ...
                    <div class="p-6 border-b">
                        ...
                        <textarea name="question" rows="4" 
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" 
                                  placeholder="Tulis soal di sini..." required>{{ old('question', $quiz->questions->first()->question ?? '') }}</textarea>
                    </div>
