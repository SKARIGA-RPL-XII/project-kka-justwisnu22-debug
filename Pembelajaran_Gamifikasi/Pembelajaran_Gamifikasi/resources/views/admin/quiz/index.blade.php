...
<head>
    ...
    <title>Quiz Management - AKU DEV</title>
    ...
    <div class="flex">
        ...
        <main class="flex-1 p-8">
            <div class="flex justify-between items-center mb-8">
                <div>
                    <h2 class="text-3xl font-bold text-white mb-2 font-bitter">Quiz Management</h2>
                        ...
                        <tbody class="divide-y divide-slate-700/50">
                            ...
                            <tr class="hover:bg-slate-700/30 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex items-center gap-3">
                                        <a href="{{ route('admin.quiz.edit', $quiz->id) }}" class="bg-blue-500/20 hover:bg-blue-500/30 text-blue-300 px-4 py-2 rounded-lg transition-all duration-200 border border-blue-500/30">
                                            Edit
                                        </a>
