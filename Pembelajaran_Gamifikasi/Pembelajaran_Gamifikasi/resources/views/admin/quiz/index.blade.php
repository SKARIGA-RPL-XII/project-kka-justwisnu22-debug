    ...
    <div class="flex">
        ...
        <main class="flex-1 p-6">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="{{ route('admin.quiz.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Tambah Quiz</a>
            </div>
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden">
                <table class="min-w-full">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        @empty
                        <tr>
                            <td colspan="4" class="px-6 py-4 text-center text-gray-500">Tidak ada data quiz</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
