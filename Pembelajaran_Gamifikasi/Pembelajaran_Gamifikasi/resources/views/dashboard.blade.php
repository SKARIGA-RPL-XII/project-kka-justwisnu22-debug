...
@section('title', 'Dashboard - AKU DEV')
...
@section('content')
    <div class="py-0">
        ...
        <script>
            setTimeout(() => { document.querySelector('.fixed.top-4').remove(); }, 3000);
        </script>
        @endif
    </div>
        ...
        <div class="mx-auto max-w-[1320px]">
            <div class="flex items-center gap-6 bg-[linear-gradient(90deg,#093595_32%,#03112F_100%)] rounded-2xl p-8 shadow-xl">
                <div class="w-24 h-24 rounded-full bg-white overflow-hidden ring-4 ring-blue-500/20">
                    ...
                    <img src="{{ route('profile.photo', Auth::id()) }}" alt="Profile" class="w-full h-full object-cover">
                    @else
    ...
    <div class="h-[50px] scale-y-[-1] mb-[-50px]" style="background-image: url('/images/pemisah.png');"></div>
@endsection
